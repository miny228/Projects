            ...
            <div class="join-container">
                <div class="join-container-inner">
                            ...
                            <li class="join-input-select">
                                <h2>구분*</h2>
	                                <select id="accountlevel" name="accountlevel">
												<option value=${vo.accountlevel } disabled="disabled">선택</option>
                            ...
                            <li class="join-input-select">
                                <h2>부서명*</h2>
	                                <select id="teamname" name="teamname">
												<option value=${vo.teamname } disabled="disabled">선택</option>
                            ...
                            <li class="join-input-select">        
                                <h2>직급*</h2>
                                	<select id="position" name="position">
												<option value=${vo.position } disabled="disabled">선택</option>
                                    ...
                                    <li class="join-input-box">
                                       ...
                                       <h2>성별*</h2>
                                        <select name="gender" id="gender" class="join-input join-input-gender" >
                                            <option value=${vo.gender } disabled="disabled">선택</option>
                                    ...
                                    <li class="join-input-box">
                                        ...
                                        <select name="pnum1" id="pnum1" class="join-input input-type4 join-input-firstnum">
                                          <option value="default">선택</option>
												<option value="010" value=${vo.pnum1 } disabled="disabled">010</option>
												<option value="011">011</option>
												<option value="016">016</option>
												<option value="017">017</option>
										</select>
                            
                                        <input type="text" name="pnum2" id="pnum2" class="join-input input-type4 join-input-phone1" value=${vo.pnum2 } ></input>

                                        <input type="text" name="pnum3" id="pnum3" class="join-input input-type4 join-input-phone2" value=${vo.pnum3 } ></input>
                                    </li>
                                    <li class="join-input-box">
                                        <h2>주소</h2>
                    ...
                    <div class="join-submit-btn-container">
                        <button type="button" class="join-submit-btn" id="btnJoin">확인</button>
                        <button type="button" class="join-submit-btn" id="btnJoin">변경</button>
                    </div>
                </div>
            </div>
        </article>
