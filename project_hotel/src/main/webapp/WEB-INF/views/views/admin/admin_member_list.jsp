	...
	<div class="content">
		<div class="content_lists">
			 <div class="content_inmenu">
	              ...
	              <ul>
		              <li id="content_list_one"><a href="http://localhost:9000/hotel/admin_member_list.do" class="content_list content_selected ">회원관리</a></li>
		...
		<div class="contents" id="contents">
			<div class="ctnInquires ctnCtUs">
				...
				<div class="account">
					...
					<div>
						<table id="listtable" border=1px solid>
							...
							<tr>
								...
								<td>2022-11-05</td>
								<td>0</td>
								<td><a href ="javascript:showModal('remark')"><button id="remarkInsert">등록</button></a></td>
							</tr>
							<tr>
								<td>2</td>
								<td>test2</td>
						...
						<tr>
							<td colspan="10"><div id="ampaginationsm"> << 1 2 3 4 5 >></div></td>
						</tr>
						</table>
					</div>
					
					<div id="remarkmodal" class="content-modal">
						<div class="modal-header">
							<div><h2>특이사항 등록</h2></div>
							<div class="modal-close btn"><img src="http://localhost:9000/hotel/resources/img/accommodation/popLayerBtnClose.gif"></div>
						</div>
						<div class="modal-content-container">
							<div class="modal-content">
								<div class="modal-content-list">
									<div><span>고객ID : </span><input name="mid" id="mid" value="test"<%-- ${mid} --%> disabled="disabled"></div>
									<div><span>고객성명 : </span><input name="name" id="name" value="테스트"<%-- ${name} --%> disabled="disabled"></div>
									<div><span>발생일 : </span><input name="happen" id="happen"></div>
									<div><span>특이사항 : </span><br> 
										<textarea cols="40" rows="5" id="rcontent" name="rcontent" class="rcontentarea" placeholder="내용을 입력해주세요"></textarea>
									</div>
					...
					<!-- 회원 검색기능 만들어야함..-->
					<form name="admin_list_search" action="admin_member_list_search.do" method="post" id="search" >
	...
	$(document).ready(function(){
		$("remarkInsert").click(function(){
 		...
 		function showremark(){
 			...
 			$("#remark-modal").css("display","block");
 			
 			$(".modal-close btn").click(function(){
 				//$(".modal-background2").css("display","none");
 	 			$("#remark-modal").css("display","none"); 				
 			});
 		}
 	</script>	
