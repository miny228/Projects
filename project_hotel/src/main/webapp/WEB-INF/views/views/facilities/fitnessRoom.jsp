       ...
       <div class="content_lists">
            <div class="content_inmenu">
                ...
                <ul>
                    ...
                    <li id="content_list_one"><a href="http://localhost:9000/hotel/shillastay/facilities/fitnessRoom.do" class="content_list content_selected">피트니스 센터</a></li>
                </ul>
            </div>
        </div>
        <div class="content_menu">
        	...
        	<div>
        	  <img src="http://localhost:9000/hotel/resources/img/facilites/R0000000LM1P_KR.gif">
        	</div>
        	<div class="content-block"></div>
        	<div class="content-facilites">
	            <img src="http://localhost:9000/hotel/resources/img/facilites/R00000009KNL_KR.jpg">
            </div>
            <div class="content-facilites-content">
	           <img src="http://localhost:9000/hotel/resources/img/facilites/R0000001IRP9_KR.gif">
           </div>
           <div>
