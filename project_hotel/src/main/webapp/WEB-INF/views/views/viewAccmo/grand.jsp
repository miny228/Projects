...
<body>
	...
	<div class="modal-background"></div>
       <div class="content_lists">
            <div class="content_inmenu">
                ...
                <ul>
                    ...
                    <li id="content_list_one"><a href="http://localhost:9000/hotel/accommodation/grand.do" class="content_list content_selected">그랜드</a></li>
        ...
        <div class="content_menu">
        	...
        	<div>
        	  <img src="http://localhost:9000/hotel/resources/img/accommodation/R0000000LMLZ_KR.gif">
        	</div>
        	<div class="content-block"></div>
        	<div class="content-rooms">
	            <img src="http://localhost:9000/hotel/resources/img/accommodation/R0000001ECGA_KR.jpg">
            </div>
            <div class="content-rooms-info">
            	<div class="content-rooms-info-left">
            		 <div>
            		   <img src="http://localhost:9000/hotel/resources/img/accommodation/R0000001DKO1_KR.jpg">
            		 </div>
 	...
 	<div class="content-modal" id="drawingmodal">
		<div class="modal-header">
			<div>
				<img src="http://localhost:9000/hotel/resources/img/accommodation/GrandpopTitle.gif">
			</div>
			<div class="modal-close btn">
				<img src="http://localhost:9000/hotel/resources/img/accommodation/popLayerBtnClose.gif">
			</div>
		...
		<div class="modal-content-one-container">
			<img class="modal-content-one"  src="http://localhost:9000/hotel/resources/img/accommodation/R000000065U8_KR.gif">
   		</div>
 	</div>
 	...
 	$("[data-nav=rooms]").children().eq(3).children().first().css("color","white");
 	</script>
