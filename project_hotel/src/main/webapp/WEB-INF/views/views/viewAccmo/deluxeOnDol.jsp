	...
	<div class="modal-background"></div>
       <div class="content_lists">
        ...
        <div class="content_menu">
        	...
        	<div>
        	  <img src="http://localhost:9000/hotel/resources/img/accommodation/R000000151RQ_KR.gif">
        	</div>
        	<div class="content-block"></div>
        	<div class="content-rooms">
	            <img src="http://localhost:9000/hotel/resources/img/accommodation/R0000001ECNA_KR.jpg">
            </div>
 	...
 	<div class="content-modal" id="drawingmodal">
		<div class="modal-header">
			<div>
				<img src="http://localhost:9000/hotel/resources/img/accommodation/bzDeluxeOndolTitle.gif">
			</div>
			<div class="modal-close btn">
				<img src="http://localhost:9000/hotel/resources/img/accommodation/popLayerBtnClose.gif">
			</div>
		...
		<div class="modal-content-one-container">
			<img class="modal-content-one"  src="http://localhost:9000/hotel/resources/img/accommodation/R000000151RK_KR.jpg">
   		</div>
 	</div>
